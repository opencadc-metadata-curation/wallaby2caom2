...
class WallabyPreview(mc.PreviewVisitor):
    """
    Generate a small thumbnail from a previously existing preview image.
    """

    def __init__(self, **kwargs):
        super().__init__(ReleaseType.META, **kwargs)
        self._science_file = self._storage_name.file_name
        self._preview_fqn = self._storage_name.get_file_fqn(self._working_dir)
...
def visit(observation, **kwargs):
    ...
    if '.png' in storage_name.file_name:
